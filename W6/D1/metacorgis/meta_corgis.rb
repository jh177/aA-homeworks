...
class MetaCorgiSnacks
  ...
  #   # Your code goes here...
  #   get_name_info = "get_#{name.to_s}_info".to_sym
  #   get_name_tastiness = "get_#{name.to_s}_tastiness".to_sym


  #   info = @snack_box.send(get_name_info, @box_id)
  #   tastiness = @snack_box.send(get_name_tastiness, @box_id)
